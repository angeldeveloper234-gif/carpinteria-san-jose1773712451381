...
export function Hero({ dynamic_city, project_counter, hook_headline }: HeroProps) {
    ...
    return (
        <section className="relative min-h-screen flex items-center pt-24 overflow-hidden bg-[#111010]">
            ...
            {/* Orange accent glow */}
            <div className="absolute top-1/2 left-1/3 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-[#FF7F50]/8 blur-[100px] rounded-full pointer-events-none" />
            ...
            <div className="container mx-auto px-6 relative z-10">
                    ...
                    <div className="font-display leading-none mb-10">
                        <h1 className="flex flex-col gap-0">
                            <span className="block text-zinc-500 text-xl md:text-3xl tracking-[0.15em] uppercase mb-2 font-sans font-light">
                                {specialization.ego} en {displayCity}
                            </span>
                ...
                >
                    <p className="text-lg md:text-xl text-zinc-400 font-sans font-light leading-relaxed border-l-4 border-[#FF7F50]/50 pl-6">
                        30 años de experiencia transformando espacios en <span className="text-white font-medium">{displayCity}</span>. Calidad artesanal y honestidad absoluta en cada entrega.
                    </p>
                ...
                >
                    {[
                        { val: `${displayProjects}+`, label: "Proyectos Entregados" },
                        { val: `${stats.experienceYears}`, label: "Años de Trayectoria" },
